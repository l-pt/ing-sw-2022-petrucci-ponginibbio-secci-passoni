...
public class CharacterTest extends TestCase {
    ...
    public void characterTest() throws IllegalMoveException, IllegalAccessException, NoSuchMethodException, InvocationTargetException, InstantiationException {
        for (int i = 0; i < 12; ++i) {
            Assertions.assertEquals(i, Character.getClassFromId(i).getDeclaredConstructor().newInstance().getId());
        }
        Exception e = assertThrows(IllegalMoveException.class, () -> Character.getClassFromId(12));
        Assertions.assertEquals("Wrong character id", e.getMessage());
    }

    @Test
    public void descriptionTest() {
        Character1 character1 = new Character1();
        Assertions.assertEquals("Take 1 student from this card and place it on an island of your choice. " +
