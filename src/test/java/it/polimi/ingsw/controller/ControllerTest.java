...
import it.polimi.ingsw.protocol.message.*;
import it.polimi.ingsw.protocol.message.character.UseCharacterColorIslandMessage;
import it.polimi.ingsw.protocol.message.character.UseCharacterMessage;
...
public class ControllerTest extends TestCase {
    ...
    @Test
    public synchronized void lastTurnMotherNatureMessageWithCharacter() throws IllegalMoveException {
        server.setMatchParameters(2, true);
        List<String> names = List.of("test1", "test2");
        Controller controller = new Controller(server, names);
        String name1 = controller.getMatch().getPlayersOrder().get(0).getName();
    ...
    @Test
    public synchronized void cloudMessageWithCharacter() throws IllegalMoveException {
        server.setMatchParameters(2, true);
        List<String> names = List.of("test1", "test2");
        Controller controller = new Controller(server, names);
        String name1 = controller.getMatch().getPlayersOrder().get(0).getName();
