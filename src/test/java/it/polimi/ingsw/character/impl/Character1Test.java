...
public class Character1Test extends TestCase {
    ...
    public void useTest() throws IllegalMoveException {
        ...
        Exception e = assertThrows(IllegalMoveException.class, () -> character.use(match, player1.getId(), finalColor1, 50));
        ...
        e = assertThrows(IllegalMoveException.class, () -> character.use(match, player1.getId(), finalColor, 0));
